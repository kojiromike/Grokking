...
function (Mage_Core_Model_Resource_Setup $installer) {
    ...
    /**
     * @var $commentModel Meeting04_Exercise03_Model_Comment
     */
    $commentModel = Mage::getModel('meeting0403/comment');
    /**
     * @var $commentCollection Meeting04_Exercise03_Model_Resource_Comment_Collection
     */
    $commentCollection = $commentModel->getResourceCollection();
    $data = array('This prod is great', 'I love cheese!', 'Words are hard');
    foreach ($data as $text) {
        /** @var Meeting04_Exercise03_Model_Comment $item */
